...
import type { GetConfigData, GetConfigResponse, GetConfigError, GetTokenData, GetTokenResponse, GetTokenError, ListNamespacesData, ListNamespacesResponse2, ListNamespacesError, CreateNamespaceData, CreateNamespaceResponse2, CreateNamespaceError, DropNamespaceData, DropNamespaceResponse, DropNamespaceError, LoadNamespaceMetadataData, LoadNamespaceMetadataResponse, LoadNamespaceMetadataError, NamespaceExistsData, NamespaceExistsResponse, NamespaceExistsError, UpdatePropertiesData, UpdatePropertiesResponse, UpdatePropertiesError, ListTablesData, ListTablesResponse2, ListTablesError, CreateTableData, CreateTableResponse, CreateTableError, PlanTableScanData, PlanTableScanResponse, PlanTableScanError, CancelPlanningData, CancelPlanningResponse, CancelPlanningError, FetchPlanningResultData, FetchPlanningResultResponse, FetchPlanningResultError, FetchScanTasksData, FetchScanTasksResponse, FetchScanTasksError, RegisterTableData, RegisterTableResponse, RegisterTableError, DropTableData, DropTableResponse, DropTableError, LoadTableData, LoadTableResponse, LoadTableError, TableExistsData, TableExistsResponse, TableExistsError, UpdateTableData, UpdateTableResponse, UpdateTableError, LoadCredentialsData, LoadCredentialsResponse2, LoadCredentialsError, RenameTableData, RenameTableResponse, RenameTableError, ReportMetricsData, ReportMetricsResponse, ReportMetricsError, CommitTransactionData, CommitTransactionResponse, CommitTransactionError, ListViewsData, ListViewsResponse, ListViewsError, CreateViewData, CreateViewResponse, CreateViewError, DropViewData, DropViewResponse, DropViewError, LoadViewData, LoadViewResponse, LoadViewError, ViewExistsData, ViewExistsResponse, ViewExistsError, ReplaceViewData, ReplaceViewResponse, ReplaceViewError, RenameViewData, RenameViewResponse, RenameViewError } from './types.gen';
...
export const planTableScan = <ThrowOnError extends boolean = false>(options: Options<PlanTableScanData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PlanTableScanResponse, PlanTableScanError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const cancelPlanning = <ThrowOnError extends boolean = false>(options: Options<CancelPlanningData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<CancelPlanningResponse, CancelPlanningError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const fetchPlanningResult = <ThrowOnError extends boolean = false>(options: Options<FetchPlanningResultData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FetchPlanningResultResponse, FetchPlanningResultError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const fetchScanTasks = <ThrowOnError extends boolean = false>(options: Options<FetchScanTasksData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<FetchScanTasksResponse, FetchScanTasksError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const loadCredentials = <ThrowOnError extends boolean = false>(options: Options<LoadCredentialsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<LoadCredentialsResponse2, LoadCredentialsError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
