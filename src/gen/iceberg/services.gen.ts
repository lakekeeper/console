...
import type { GetConfigData, GetConfigError, GetConfigResponse, GetTokenData, GetTokenError, GetTokenResponse, ListNamespacesData, ListNamespacesError, ListNamespacesResponse2, CreateNamespaceData, CreateNamespaceError, CreateNamespaceResponse2, LoadNamespaceMetadataData, LoadNamespaceMetadataError, LoadNamespaceMetadataResponse, NamespaceExistsData, NamespaceExistsError, NamespaceExistsResponse, DropNamespaceData, DropNamespaceError, DropNamespaceResponse, UpdatePropertiesData, UpdatePropertiesError, UpdatePropertiesResponse, ListTablesData, ListTablesError, ListTablesResponse2, CreateTableData, CreateTableError, CreateTableResponse, RegisterTableData, RegisterTableError, RegisterTableResponse, LoadTableData, LoadTableError, LoadTableResponse, UpdateTableData, UpdateTableError, UpdateTableResponse, DropTableData, DropTableError, DropTableResponse, TableExistsData, TableExistsError, TableExistsResponse, RenameTableData, RenameTableError, RenameTableResponse, ReportMetricsData, ReportMetricsError, ReportMetricsResponse, CommitTransactionData, CommitTransactionError, CommitTransactionResponse, ListViewsData, ListViewsError, ListViewsResponse, CreateViewData, CreateViewError, CreateViewResponse, LoadViewData, LoadViewError, LoadViewResponse, ReplaceViewData, ReplaceViewError, ReplaceViewResponse, DropViewData, DropViewError, DropViewResponse, ViewExistsData, ViewExistsError, ViewExistsResponse, RenameViewData, RenameViewError, RenameViewResponse } from './types.gen';
