...
export const GetWarehouseResponseSchema = {
    type: 'object',
    required: ['id', 'name', 'project-id', 'storage-profile', 'delete-profile', 'status', 'protected'],
    properties: {
        'delete-profile': {
            '$ref': '#/components/schemas/TabularDeleteProfile',
...
export const ProtectionResponseSchema = {
    type: 'object',
    required: ['protected'],
    properties: {
        protected: {
...
export const SetProtectionRequestSchema = {
    type: 'object',
    required: ['protected'],
    properties: {
        protected: {
