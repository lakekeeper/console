...
import type { ActivateWarehouseData, ActivateWarehouseError, ActivateWarehouseResponse, BootstrapData, BootstrapError, BootstrapResponse, CreateProjectData, CreateProjectError, CreateProjectResponse2, CreateRoleData, CreateRoleError, CreateRoleResponse, CreateUserData, CreateUserError, CreateUserResponse, CreateWarehouseData, CreateWarehouseError, CreateWarehouseResponse2, DeactivateWarehouseData, DeactivateWarehouseError, DeactivateWarehouseResponse, DeleteDefaultProjectError, DeleteDefaultProjectResponse, DeleteProjectByIdData, DeleteProjectByIdError, DeleteProjectByIdResponse, DeleteRoleData, DeleteRoleError, DeleteRoleResponse, DeleteUserData, DeleteUserError, DeleteUserResponse, DeleteWarehouseData, DeleteWarehouseError, DeleteWarehouseResponse, GetDefaultProjectError, GetDefaultProjectResponse, GetNamespaceAccessByIdData, GetNamespaceAccessByIdError, GetNamespaceAccessByIdResponse, GetNamespaceAssignmentsByIdData, GetNamespaceAssignmentsByIdError, GetNamespaceAssignmentsByIdResponse, GetNamespaceByIdData, GetNamespaceByIdError, GetNamespaceByIdResponse, GetProjectAccessByIdData, GetProjectAccessByIdError, GetProjectAccessByIdResponse, GetProjectAccessData, GetProjectAccessError, GetProjectAccessResponse2, GetProjectAssignmentsByIdData, GetProjectAssignmentsByIdError, GetProjectAssignmentsByIdResponse, GetProjectAssignmentsData, GetProjectAssignmentsError, GetProjectAssignmentsResponse2, GetProjectByIdData, GetProjectByIdError, GetProjectByIdResponse, GetRoleAccessByIdData, GetRoleAccessByIdError, GetRoleAccessByIdResponse, GetRoleAssignmentsByIdData, GetRoleAssignmentsByIdError, GetRoleAssignmentsByIdResponse, GetRoleData, GetRoleError, GetRoleResponse, GetServerAccessData, GetServerAccessError, GetServerAccessResponse2, GetServerAssignmentsData, GetServerAssignmentsError, GetServerAssignmentsResponse2, GetServerInfoError, GetServerInfoResponse, GetTableAccessByIdData, GetTableAccessByIdError, GetTableAccessByIdResponse, GetTableAssignmentsByIdData, GetTableAssignmentsByIdError, GetTableAssignmentsByIdResponse, GetUserData, GetUserError, GetUserResponse, GetViewAccessByIdData, GetViewAccessByIdError, GetViewAccessByIdResponse, GetViewAssignmentsByIdData, GetViewAssignmentsByIdError, GetViewAssignmentsByIdResponse, GetWarehouseAccessByIdData, GetWarehouseAccessByIdError, GetWarehouseAccessByIdResponse, GetWarehouseAssignmentsByIdData, GetWarehouseAssignmentsByIdError, GetWarehouseAssignmentsByIdResponse, GetWarehouseByIdData, GetWarehouseByIdError, GetWarehouseByIdResponse, GetWarehouseData, GetWarehouseError, GetWarehouseResponse2, ListDeletedTabularsData, ListDeletedTabularsError, ListDeletedTabularsResponse2, ListProjectsError, ListProjectsResponse2, ListRolesData, ListRolesError, ListRolesResponse2, ListUserData, ListUserError, ListUserResponse, ListWarehousesData, ListWarehousesError, ListWarehousesResponse2, RenameDefaultProjectData, RenameDefaultProjectError, RenameDefaultProjectResponse, RenameProjectByIdData, RenameProjectByIdError, RenameProjectByIdResponse, RenameWarehouseData, RenameWarehouseError, RenameWarehouseResponse, SearchRoleData, SearchRoleError, SearchRoleResponse2, SearchUserData, SearchUserError, SearchUserResponse2, SetNamespaceManagedAccessData, SetNamespaceManagedAccessError, SetNamespaceManagedAccessResponse, SetWarehouseManagedAccessData, SetWarehouseManagedAccessError, SetWarehouseManagedAccessResponse, UpdateNamespaceAssignmentsByIdData, UpdateNamespaceAssignmentsByIdError, UpdateNamespaceAssignmentsByIdResponse, UpdateProjectAssignmentsByIdData, UpdateProjectAssignmentsByIdError, UpdateProjectAssignmentsByIdResponse, UpdateProjectAssignmentsData, UpdateProjectAssignmentsError, UpdateProjectAssignmentsResponse, UpdateRoleAssignmentsByIdData, UpdateRoleAssignmentsByIdError, UpdateRoleAssignmentsByIdResponse, UpdateRoleData, UpdateRoleError, UpdateRoleResponse, UpdateServerAssignmentsData, UpdateServerAssignmentsError, UpdateServerAssignmentsResponse, UpdateStorageCredentialData, UpdateStorageCredentialError, UpdateStorageCredentialResponse, UpdateStorageProfileData, UpdateStorageProfileError, UpdateStorageProfileResponse, UpdateTableAssignmentsByIdData, UpdateTableAssignmentsByIdError, UpdateTableAssignmentsByIdResponse, UpdateUserData, UpdateUserError, UpdateUserResponse, UpdateViewAssignmentsByIdData, UpdateViewAssignmentsByIdError, UpdateViewAssignmentsByIdResponse, UpdateWarehouseAssignmentsByIdData, UpdateWarehouseAssignmentsByIdError, UpdateWarehouseAssignmentsByIdResponse, UpdateWarehouseDeleteProfileData, UpdateWarehouseDeleteProfileError, UpdateWarehouseDeleteProfileResponse, WhoamiError, WhoamiResponse } from './types.gen';
