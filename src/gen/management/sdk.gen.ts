...
export const deleteDefaultProjectDeprecated = <ThrowOnError extends boolean = false>(options?: Options<DeleteDefaultProjectDeprecatedData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).delete<DeleteDefaultProjectDeprecatedResponse, DeleteDefaultProjectDeprecatedError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getDefaultProjectDeprecated = <ThrowOnError extends boolean = false>(options?: Options<GetDefaultProjectDeprecatedData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetDefaultProjectDeprecatedResponse, GetDefaultProjectDeprecatedError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const renameDefaultProjectDeprecated = <ThrowOnError extends boolean = false>(options: Options<RenameDefaultProjectDeprecatedData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, RenameDefaultProjectDeprecatedError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
