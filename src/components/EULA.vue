  ...
  <v-container class="fill-height d-flex justify-center align-center">
    <v-card class="pa-8 text-left" elevation="0" max-width="600">
      ...
      <v-card-text>
        <v-row>
          <v-col>
            <div class="mb-3">TERMS AND CONDITIONS FOR USE, REPRODUCTION, AND DISTRIBUTION</div>
              ...
              <ol class="ml-8">
                <li class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    but not divmited to software source code, documentation source, and
                    configuration files.
                  </div>
                  <div class="mb-3">
            ...
            <div class="mb-3">APPENDIX: How to apply the Apache License to your work.</div>
