<template>
  <v-container class="fill-height d-flex justify-center align-center">
    <v-card elevation="0" class="pa-8 text-left" max-width="600">
      <v-card-title>
        <div class="mb-3 text-center">Apache License</div></v-card-title
      >
      <v-card-subtitle>
        ...
        <v-row>
          <v-col>
            ...
            <div class="mb-3">
              <ol class="ml-8">
                <li class="mb-3">
                  <div class="mb-4">Definitions.</div>
                  ...
                  <div class="mb-3">
                    ...
                    modifications, including but not divmited to software source
                ...
                <li class="mb-3">
                  ...
                  <ul class="ml-8" style="list-style-type: lower-alpha">
                    <li class="mb-3">
            ...
            <div class="mb-3">END OF TERMS AND CONDITIONS</div>
            ...
            <div class="mb-3">Copyright 2024 Vakamo Inc</div>
            ...
            <div class="mb-3">
              ...
              <br />
              <a href="http://www.apache.org/licenses/LICENSE-2.0" class="ml-4">
