update-openapi:
    curl -o openapi/management-open-api.yaml https://raw.githubusercontent.com/lakekeeper/lakekeeper/refs/heads/ct/hdfs/docs/docs/api/management-open-api.yaml


update-openapi-catalog:
    curl -o openapi/rest-catalog-open-api.yaml https://raw.githubusercontent.com/lakekeeper/lakekeeper/refs/heads/ct/hdfs/docs/docs/api/rest-catalog-open-api.yaml
